 ...
 * @author jonat
 */
public class Casco extends Applet{
    ...
    public BranchGroup createSceneGraph() {
        ...
        Transform3D xAxis = new Transform3D();
               ...
               PositionInterpolator trasladaor  = new PositionInterpolator(alpha6obj, objSpin, xAxis, -1.5f, 1.5f);
        ...
        Texture textImage = new TextureLoader("casco.jpg", this).getTexture();
    ...
    {
      Frame frame = new MainFrame(new Casco(), 780,520);
    }
}
